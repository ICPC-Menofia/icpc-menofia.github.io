...
<div class="hero-section">
  ...
  <div class="hero-buttons">
    ...
    <a href="https://vjudge.net/group/icpc-menofia-level1-2025" target="_blank" class="md-button md-button--primary">Go to Practice Sheet</a>
  </div>
</div>
    ...
    <div class="coaches-section-integrated">
      ...
      <div class="level1-coaches">
        <div class="coaches-grid">
          <a href="../../community/coaches.md#ahmed-mohamed" class="coach-card">
            <div class="coach-name">Ahmed Mohamed</div>
          </a>
          <a href="../../community/coaches.md#mohamed-khaled" class="coach-card">
            <div class="coach-name">Mohamed Khaled</div>
          </a>
          <a href="../../community/coaches.md#abdelrhman-mostafa" class="coach-card">
            <div class="coach-name">Abdelrhman Mostafa</div>
          </a>
          <a href="../../community/coaches.md#mohamed-hani" class="coach-card">
            <div class="coach-name">Mohamed Hani</div>
          </a>
          <a href="../../community/coaches.md#abdelrhman-elhabal" class="coach-card">
            <div class="coach-name">Abdelrhman Elhabal</div>
          </a>
          <a href="../../community/coaches.md#maryam-abdelhady" class="coach-card">
            <div class="coach-name">Maryam Abdelhady</div>
          </a>
          <a href="../../community/coaches.md#menna-fathy" class="coach-card">
